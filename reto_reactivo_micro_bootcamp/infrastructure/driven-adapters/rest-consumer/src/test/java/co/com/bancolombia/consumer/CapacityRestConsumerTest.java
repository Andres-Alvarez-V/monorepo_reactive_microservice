...
public class CapacityRestConsumerTest {
    ...
    private static CapacityRestConsumer capacityRestConsumer;
    ...
    static void setUp() throws IOException {
        ...
        capacityRestConsumer = new CapacityRestConsumer(webClient);
    }
    ...
    void validateTestGet() {
        ...
        mockBackEnd.enqueue(new MockResponse()
                ...
                .setBody("{\"state\" : \"ok\"}"));
        var response = capacityRestConsumer.testGet();
    ...
    void validateTestPost() {
        ...
        mockBackEnd.enqueue(new MockResponse()
                ...
                .setResponseCode(HttpStatus.OK.value())
                .setBody("{\"state\" : \"ok\"}"));
        var response = capacityRestConsumer.testPost();
